...
import (
	...
	energyawareusage "k8s.io/kubernetes/pkg/scheduler/framework/plugins/energyawareusage"
	energyawareeatsvm "k8s.io/kubernetes/pkg/scheduler/framework/plugins/energyawareeatsvm"
	resourcevectorsimilarity "k8s.io/kubernetes/pkg/scheduler/framework/plugins/resourcevectorsimilarity"
	densepackingdpm "k8s.io/kubernetes/pkg/scheduler/framework/plugins/densepackingdpm"
...
func NewInTreeRegistry() runtime.Registry {
	...
	registry := runtime.Registry{
		...
		energyawareusage.Name:                energyawareusage.New,
		energyawareeatsvm.Name:               energyawareeatsvm.New,
		resourcevectorsimilarity.Name:        resourcevectorsimilarity.New,
		densepackingdpm.Name:                 densepackingdpm.New,
	}
